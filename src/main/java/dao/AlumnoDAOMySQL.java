...
public class AlumnoDAOMySQL implements AlumnoDAO {
    ...
    public static final String listadoporprofesor = "SELECT alumno.* FROM `alumno`,profesor WHERE alumno.profesor=profesor.nombre and profesor.id_profesor=?;";
    ...
    public static final String getAll = "select * from alumno;";
    ...
    public ArrayList<Alumno> alumnolist(Profesor profesor) {
        ...
        try (var pst = conexion.prepareStatement(listadoporprofesor)) {
            ...
            while (resultSet.next()) {
                ...
                alumno.setHorasDual(horasDual(alumno.getId_alumno()));
                alumno.setHorasFCT(horasFCT(alumno.getId_alumno()));
